...
public class BinarySearchTree {
	...
	/*
	  ...
	  * 3. Node to be deleted has 2 child. In this case we can take 2 approaches
	  *     3.1 Find the minimum from the right and replace it with the node to be deleted.
	  *     3.2 Find the maximum from the left and replace it with the node to be deleted.
	  */
